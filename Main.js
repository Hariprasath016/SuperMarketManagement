...
class Main extends React.Component {
    render() {
        return (
            <>
                <header className="header" style={{ height: "25vh", width: "100vw", backgroundColor: "#339ac7", overflow: "hidden" }}>
                    <nav>
                        <a href="/" id="heading-topic"><img style={{ height: "5vh" }} src={AvenueLOGO} alt="" /></a>
                        <a href="/" id="heading-logo" style={{transform:"translateX(0%)", color:"##339ac7"}}>&nbsp;</a>
                    </nav>
                    <hr id="header-hr" />
                ...
                <footer style={{ height: "4vh", width: "100vw", backgroundColor: "#000080" }}>
                    <p>@*-* THE AVENUE SUPERMARKET *-*@       -for *contacts*-avenue2023@gmail.com//ph:9999887777</p>
